...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/carshop/index.php">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Message/lst">留言管理</a><span class="crumb-step">&gt;</span><span>查看及回复留言</span></div>
        </div>
                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>管理员回复：</th>
                                <td><textarea name="content" class="common-textarea" cols="75" rows="6"></textarea></td>
                            </tr>
