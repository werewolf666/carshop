                ...
                <div class="result-content">
                    <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <table class="insert-tab" width="100%">
                            <tbody><tr>
                                ...
                                <td>
                                    <select name="parentid" id="catid" class="required">
                                        ...
                                        <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo["id"] == cateres.id): ?>style="display:none";<?php endif; ?>value="<?php echo ($vo["id"]); ?>">
                                                <?php if($vo['parentid'] != 0): endif; ?>
                                                <?php echo str_repeat('-',$vo['level']*4); echo ($vo["name"]); ?>
                            ...
                            <tr>
                                <th>描述：</th>
                                <td><textarea name="des" class="common-textarea" id="des" cols="30" style="width: 98%;" rows="5"><?php echo ($cateres["des"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>是否是pc端：</th>
                                <td>
                                    <input name="pc" value="1" <?php if($cateres["pc"] == 1): ?>checked="checked"<?php endif; ?> type="checkbox">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($cateres["pic"] != ''): ?><img src="/carshop<?php echo ($cateres["pic"]); ?>" height="50" width="50"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="common-text" name="type" size="50" value="7" <?php if($cateres["type"] == 7): ?>checked="checked"<?php endif; ?>  type="radio">求职列表
                                </td>
                            </tr>
                            <tr>
                                <th>栏目级别：</th>
                            ...
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo (htmlspecialchars_decode($cateres["content"])); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
