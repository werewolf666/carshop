    ...
    <div class="sidebar-wrap">
        ...
        <div class="main-wrap">
            <div class="crumb-wrap">
                <div class="crumb-list"><i class="icon-font"></i><a href="/carshop/index.php/Admin/index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Article/lst">文章管理</a><span class="crumb-step">&gt;</span><span>修改文章</span></div>
            </div>
                    ...
                    <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <table class="insert-tab" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="cateid" id="catid" class="required">
                                        <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($articles['cateid']==$vo['id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php if($vo['parentid'] != 0): ?>|<?php endif; echo str_repeat('-', $vo['level']*8); echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>作者：</th>
                                <td>
                                    <input class="common-text required" id="author" name="author" size="50" value="<?php echo ($articles["author"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>关键词：</th>
                                <td><input class="common-text" name="keywords" size="50" value="<?php echo ($articles["keywords"]); ?>" type="text"></td>
                            </tr>
                            <tr>
                                <th>描述：</th>
                                <td><textarea name="des" class="common-textarea" id="des" cols="30" style="width: 98%;" rows="5"><?php echo ($articles["des"]); ?></textarea></td>
                            </tr>
                            <tr>
                                <th>是否推荐：</th>
                                <td>
                                    <input <?php if($articles["rem"] == 1): ?>checked="checked"<?php endif; ?> class="common-text" name="rem" size="50" value="1" type="checkbox">推荐
                                </td>
                            </tr>
                            <tr>
                                <th>文章类型：</th>
                                <td>
                                    <div id="atype">
                                        <input class="common-text" name="atype" size="50" value="0" <?php if($articles["atype"] == 0): ?>checked="checked"<?php endif; ?> type="radio">列表
                                        <input class="common-text" name="atype" size="50" value="1" <?php if($articles["atype"] == 1): ?>checked="checked"<?php endif; ?> type="radio">车型
                                        <input class="common-text" name="atype" size="50" value="2" <?php if($articles["atype"] == 2): ?>checked="checked"<?php endif; ?> type="radio">招聘
                                    </div>
                                </td>
                            </tr>
                            <tr class="btype">
                                <th>列表附加选项：</th>
                                <td>
                                    <input class="common-text" name="" size="50" value="" type="text">列表
                                </td>
                            </tr>
                            <tr class="btype">
                                <th>车型附加选项：</th>
                                <td>
                                    <input class="common-text" name="rizu" size="50" value="<?php echo ($articles["rizu"]); ?>" type="text">元/天（日租价格）
                                </td>
                            </tr>
                            <tr class="btype">
                                <th>招聘附加选项：</th>
                                <td>
                                    <input class="common-text" name="num" size="50" value="<?php echo ($articles["num"]); ?>" type="text">招聘
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($articles["pic"] != ''): ?><img src="/carshop<?php echo ($articles["pic"]); ?>" height="50" width="50"/>
                            ...
                            <tr>
                                <th>内容：</th>
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo (htmlspecialchars_decode($articles["content"])); ?></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
...
<script type="text/javascript">
    ...
    $('.btype').hide();
    $('.btype').eq(<?php echo ($articles["atype"]); ?>).show();
