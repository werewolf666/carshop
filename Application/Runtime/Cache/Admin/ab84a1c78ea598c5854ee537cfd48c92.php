...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/carshop/index.php/Admin/index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/carshop/index.php/Admin/Role/lst">角色管理</a><span class="crumb-step">&gt;</span><span>新增角色</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if($vo['parentid'] != 0): ?>|<?php endif; echo str_repeat('-', $vo['level']*4);?>
...
<script type="text/javascript">
    ...
    $(":checkbox").click(function(){
        var cur_li=$(this).parent(); //选中当前的标签上面所有的栏目
        var level=cur_li.attr("level"); //获取上级所有栏目的level值
        var checked=$(this).attr("checked");//获取所有上级栏目的选择状态
        cur_li.prevAll("li").each(function(){ //循环所有上级的标签
            if($(this).attr("level")<level && checked ){ //某个上级栏目的level值小于当前并且选中情况
                $(this).find(":checkbox").attr("checked","checked");
                if($(this).attr("level")==0){ //找到顶级了，便不往下选择
                    return false;
                }
            }
        });
