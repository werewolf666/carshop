            ...
            <form action="" name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/carshop/index.php/Admin/Cate/add"><i class="icon-font"></i><input type="button" value="新增栏目" /></a>
                        <a id="batchDel" href=""><i class="icon-font"></i><input  form="myform" formaction="/carshop/index.php/Admin/Cate/bdel" type="submit" value="批量删除" /></a>
                        <a id="updateOrd" href=""><i class="icon-font"></i><input form="myform" formaction="/carshop/index.php/Admin/Cate/sortcate" type="submit" value="更新排序" /></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php if($vo['parentid' != 0]): endif; echo str_repeat('-',$vo['level']*4); echo ($vo["name"]); ?></td>
                                <td>
                                    ...
                                    <?php if($vo["type"] == 7): ?>求职列表<?php endif; ?>
                                </td>
                                <td>
                                    <?php if($vo['pic'] != ''): ?><img src="/carshop<?php echo ($vo["pic"]); ?>" height="50" width="50"/>
                                    <?php else: ?>
                                    暂无缩略图<?php endif; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a class="link-update" href="/carshop/index.php/Admin/Cate/edit/id/<?php echo ($vo["id"]); ?> ">修改</a>
                                    <a class="link-del" onclick="return confirm('确定要删除本栏目及其子栏目?');" href="/carshop/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                                </td>
