...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/carshop/index.php/Admin/index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">文章管理</span></div>
        </div>
                ...
                <form action="" method="post">
                    <table class="search-tab">
                        <tr>
                            ...
                            <th width="70">关键字:</th>
                            <td><input class="common-text" placeholder="关键字" name="kw" value="" id="kw" type="text"></td>
            ...
            <form action="" name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/carshop/index.php/Admin/Article/add"><i class="icon-font"></i><input type="button" value="新增文章" /></a>
                        <a id="batchDel" href=""><i class="icon-font"></i><input  form="myform" formaction="/carshop/index.php/Admin/Article/bdel" type="submit" value="批量删除" /></a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <?php if($vo["rem"] == 1): ?>推荐<?php else: ?>未推荐<?php endif; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a class="link-del" onclick="return confirm('确定要删除本文章?');" href="/carshop/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                                </td>
