      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/carshop/index.php/Home/Message/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
		...
		<div class="title"> <span class="fl"><?php echo ($selftop); ?></span> <span class="fr">当前位置：<a href="/carshop/index.php" title="首页">首页</a> > 
          ...
          <?php if(is_array($mres)): $i = 0; $__LIST__ = $mres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="pngFix booktop">
                <div class="booktop_name"><span class="messagecol"><?php echo ($vo["nickname"]); ?></span> 说：</div>
                <div class="booktop_time"></div>
            </div>
            <div class="bookcontent"><?php echo ($vo["content"]); ?><span class="admintimecol "><?php echo (date("Y年m月d H:i",$vo["time"])); ?>             </span>      </div>
            ...
            <div class="bookadmin_top">
                <img height="12" src="http://0001543.ks.panguweb.cn/images/admintop.gif">
            </div>
            <div class="bookadmin_mid"><span class="admincol fl">管理员回复：</span>
                <span style="width:400px;" class="txtcon fl"><?php echo ($vo1["content"]); ?></span>
                <span class="admintimecol fl"><?php echo (date("Y年m月d H:i",$vo1["time"])); ?></span>
            </div>
      ...
      <form action="" id="MsgForm" name="MsgForm" method="post">
        <ul>
          ...
          <li class="yzm">
            ...
            <p class="message_yzmico"><img width="150" align="absmiddle" onclick="this.src='/carshop/index.php/Home/Message/code/'+Math.random();" style="cursor:pointer;" title="看不清？点击一下！" alt="看不清？点击一下！" src="/carshop/index.php/Home/Message/code" id="verify"></p>
