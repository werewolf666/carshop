      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/carshop/index.php/Home/Article/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
        ...
        <div class="fyRight">
                ...
                <div class="aaleft1" >
      			...
      			<div class="title"> <span class="fl"> 主要车型</span> <span class="fr">当前位置：<a href="/carshop/index.php" title="首页">首页</a> > 
				...
				<div class="padding25">
                    ...
                    <p class="title_s">文章作者：<?php echo ($articles["author"]); ?>&nbsp;&nbsp;&nbsp;&nbsp;时间：<?php echo (date("Y-m-d",$articles["time"])); ?></p>
                                        <p class="center"><img src="/carshop/<?php echo ($articles["pic"]); ?>" alt="车型：车型展示名称" /></p>
                                        <p class="pro-ri">
