      ...
      <div class="l_pro_t"><?php echo ($topname); ?></div>
        <ul class="l_procon">
          ...
          <li class="proOne"><a title="<?php echo $v['name'];?>" href="<?php echo $url;?>"><?php echo $v['name'];?></a>
            ...
            <li><a style="padding-left:50px;" title="<?php echo $v1['name'];?>" href="/carshop/index.php/Home/Zplist/index/cateid/<?php echo $v1['id'];?>"><?php echo $v1['name'];?></a></li>
              <?php endforeach;?>
          <?php endif;?>
            </ul>
...
邮箱：<?php echo (C("EMAIL")); ?> </div>
  ...
  <div class="fyRight">
      ...
      <div class="hrBoxR">
        <ul>
          <li class="topline"><span class="fl"><?php echo ($vo["title"]); ?></span><a title="应聘此职位" class="fr" href="/carshop/index.php/Home/Job/index/arid/<?php echo ($vo["id"]); ?>"><img width="90" height="26" src="/carshop/Public/pc/images/re.gif"></a>
            <div class="clear"></div>
          </li>
