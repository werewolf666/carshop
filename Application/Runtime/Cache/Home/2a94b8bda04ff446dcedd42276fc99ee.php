...
<div class="fixed"> <a href="book.php" title="留言" class="barbook"></a> <a href="javascript:;" title="二维码" class="codepic"></a> <a href="javascript:;" title="返回顶部" class="backup"></a>
  <div> <img src="<?php echo HOME_PUC;?>/images/qrcode.png" alt="这里是您的网站名称" class="code" /> </div>
</div>
<div class="fixed"> <a href="book.php" title="留言" class="barbook"></a> <a href="javascript:;" title="二维码" class="codepic"></a> <a href="javascript:;" title="返回顶部" class="backup"></a>
    <div> <img src="/carshop/Public/pc/images/qrcode.png" alt="这里是您的网站名称" class="code" /> </div>
</div>
<div class="head">
  <div class="headtop">
      <div class="fra1">
          <a href="/carshop/index.php" title="这里是您的网站名称"><img src="<?php echo HOME_PUC;?>/images/logo.png" alt="这里是您的网站名称" /></a>
...
<div class="banner">
  <div class="main_visual">
    <div class="main_image">
      <ul>
        <li><img src="/carshop/Public/pc/images/20150804112838-1533884976.jpg" alt=""/></li>
      </ul>
          ...
          <ul class="caseul">
              <?php if(is_array($mainres)): $i = 0; $__LIST__ = $mainres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                      <a href="/carshop/index.php/Home/Article/Index/arid/<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["title"]); ?>">
                          <img src="/carshop/<?php echo ($vo["pic"]); ?>" alt="车型：<?php echo ($vo["title"]); ?>" width="215" height="161" />
      ...
      <div id="example">
        <div id="slides">
          <div class="slides_container" >
              <div class="slide">
               	<ul class="product-ul">
                    <?php if(is_array($carres)): $i = 0; $__LIST__ = $carres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><li>
                            <a href="/carshop/index.php/Home/Article/Index/arid/<?php echo ($vo1["id"]); ?>" title="车型：<?php echo ($vo1["title"]); ?>">
                                <p class="casetitle" >
                                    <span title="车型：<?php echo ($vo1["title"]); ?>" class="zoombut"></span>
                                    <span class="jianjie">车型：车型展示名称</span>
                                </p>
                                <img src="/carshop/<?php echo ($vo1["pic"]); ?>" width="245" height="184" alt="车型：<?php echo ($vo1["title"]); ?>" />
                                <p class="wor"><span>车型：<?php echo ($vo1["title"]); ?></span><label>日租：<?php echo ($vo1["rizu"]); ?>元/天</label></p>
                            </a>
                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
            	</ul>
            </div>
...
<div class="news">
	<div class="fra">
    	<div class="about-left">
            ...
            <p class="ab-con"><?php echo ($aboutres['content']); ?></p>
			<a class="ab-more" href="/carshop/index.php/Home/Page/index/cateid/67" title="查看更多">查看更多</a>
        </div>
        <div class="news-right">
            ...
            <a class="news-more" href="/carshop/index.php/Home/Arlist/index/cateid/69" title="查看更多">查看更多</a>
        </div>
    </div>
</div>
<div class="z-notice">
	<a href="" title="租车须知">租车须知</a>
	<img src="<?php echo HOME_PUC;?>/images/20150804152838-947160084.jpg" alt="租车" width="1000" height="250" />
</div>
<div class="clear"></div>
<div class="foot">
  <div class="foot-map">
