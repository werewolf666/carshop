        ...
        <div class="content">
            ...
            <ul class="login">
              ...
              <input type="hidden" name="type" value="0" />
                <li>
                    <input class="login_input" name="nickname" type="text" id="nickname" placeholder="标题*"/>
                </li>
                  <li>
                      <input class="login_input" name="telephone" type="text" id="telephone" placeholder="电话号码*"/>
                  </li>
                <li>
