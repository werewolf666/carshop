...
<div class="allpage">
 ...
 <div class="header">
    ...
    <div class="content">
        <a href="/carshop/index.php/Mobile/Message/addmsg" title="我要留言" class="to_msg common_bg">我要留言</a>
...
<a href="javascript:void(0);" title="我要留言" id="imore" class="imore">查看更多</a>
        </div>
     <div class="footer">
...
<script language="javascript">
    ...
    function getlist(page){
        $.ajax({
            type:"GET",
            url:"/carshop/index.php/Mobile/Message/getlist/p/"+page+"/cateid/<?php echo I('get.cateid');?>",
            dataType:"json",
